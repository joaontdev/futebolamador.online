            ...
            <div class="row align-items-center min-vh-100 py-5">
                ...
                <div class="col-lg-6">
                    <div class="hero-image-container animate-slide-in">
                        <img src="assets/images/hero-image.png" alt="Futebol Amador" class="img-fluid rounded-4 shadow-lg">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4">
                    <div class="feature-card card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            <div class="feature-icon bg-custom text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 80px; height: 80px;">
                                <i class="bi bi-people-fill fs-2"></i>
                            </div>
                            <h4 class="fw-bold mb-3">1. Cadastre sua Equipe</h4>
                            <p class="text-muted">
                                Primeiro, você deve cadastrar sua equipe na plataforma. Se a equipe já existir, você pode pular esta etapa. O cadastro é simples e rápido, incluindo nome da equipe, cidade e informações básicas.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="feature-card card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted">
                                Depois, você adiciona o confronto entre duas equipes informando ambas as equipes participantes, a data do jogo, o local onde será realizado e o resultado final da partida.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="feature-card card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted">
                                Assim que o confronto for adicionado, o resultado será automaticamente exibido na página inicial da plataforma, permitindo que todos acompanhem os jogos e resultados das equipes.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted mb-0">Cadastre equipes rapidamente com informações essenciais</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted mb-0">Visualize resultados na página inicial instantaneamente</p>
                                    </div>
                                </div>
                            </div>
                        </div>
