                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="form-container">
                        ...
                        <div class="text-center mb-5">
                            ...
                            <h1 class="display-6 fw-bold text-dark mb-3">Login</h1>
                        ...
                        <!-- Form -->
                        <form method="post" action="<?= BASE_URL  ?>/login/acessar" id="cadastroEquipeForm" class="needs-validation" novalidate>
                            <div class="row g-4">
                                <!-- Nome da Equipe -->
                                <div class="col-12">
                                    <label for="nomeUsuario" class="form-label fw-semibold">
                                        Usuário *
                                    </label>
                                    <input type="text" class="form-control form-control-lg" id="nomeUsuario"
                                ...
                                <!-- Logradouro -->
                                <div class="col-12">
                                    <label for="senhaUsuario" class="form-label fw-semibold">
                                        Senha *
                                    </label>
                                    <input type="password" class="form-control form-control-lg" id="senhaUsuario"
